...
if __name__ == '__main__':
    ...
    argparser.add_argument("-r", "--run", dest="run_program", default='bertchunker.py', help="run this program against testcases [default: bertchunker.py]")
    argparser.add_argument("-x", "--pythonbin", dest="python_bin", default='/Users/davidqian/micromamba/bin/python', help="run this binary of Python to run the program [default: python3]")
